      ...
      <div className="bg-white rounded-lg max-w-4xl w-full max-h-[90vh] overflow-y-auto mx-2 sm:mx-0">
        <div className="p-4 sm:p-6 border-b border-gray-200">
          <div className="flex justify-between items-start">
            <div className="flex-1 min-w-0">
              <h3 className="text-lg sm:text-2xl font-bold text-gray-900 truncate">{project.title}</h3>
              <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 mt-2">
                ...
                <span className="text-xs sm:text-sm text-gray-500 flex items-center gap-1">
                  ...
                  <span className="truncate">{project.organization_email}</span>
                </span>
                <span className="text-xs sm:text-sm text-gray-500 flex items-center gap-1">
        ...
        <div className="p-4 sm:p-6">
          <div className="space-y-6">
            <div>
              <h4 className="text-base sm:text-lg font-semibold text-gray-900 mb-3">Project Description</h4>
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
        <div>
          <h2 className="text-xl sm:text-2xl font-bold text-gray-900">Project Approval Management</h2>
          <p className="text-gray-600 mt-1 text-sm sm:text-base">
            Projects pending approval before being published on the site
          </p>
        </div>
        <Button onClick={loadPendingProjects} variant="secondary" className="w-full sm:w-auto">
      ...
      {pendingProjects.length === 0 ? (
        <div className="bg-white rounded-lg shadow border p-6 sm:p-8 text-center">
        ...
        <div className="space-y-4">
          {pendingProjects.map((project) => (
            <div 
              key={project.id} 
              className={`bg-white rounded-lg shadow border-l-4 p-4 sm:p-6 ${getUrgencyColor(project.hours_waiting)}`}
            >
              <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-4">
                ...
                <div className="flex flex-row sm:flex-col gap-2 w-full sm:w-auto sm:mr-4">
                  <Button
